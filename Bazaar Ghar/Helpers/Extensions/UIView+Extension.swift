...
extension UIColor {
    ...
    static let oceanBlue = UIColor(named: "headercolor")
    ...
    static let primaryColor = UIColor(named: "headercolor");
    static let headerSecondaryColor = UIColor(hexString: "#FF7544");
